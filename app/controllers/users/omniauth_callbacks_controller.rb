class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  def google_oauth2
    ...
    if @user.persisted?
      ...
      redirect_to new_user_registration_url, alert: "No se pudo autenticar con Google."
    end
  end
  ...
  def microsoft_graph
    ...
    if @user.persisted?
      ...
      redirect_to new_user_registration_url, alert: "No se pudo autenticar con Microsoft."
    end
  end

  def failure
    redirect_to root_path, alert: "Error al autenticar."
  end
end
